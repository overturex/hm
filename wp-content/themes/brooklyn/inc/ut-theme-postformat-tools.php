...
if( !function_exists('ut_flex_slider') ) {
    ...
    function ut_flex_slider( $postID ) {
		...
		(function($){
			...
			$(window).load(function(){
				...
				$('#gallery-slider-<?php echo $postID; ?>').flexslider({
					...
					smoothHeight: true,
					start: function(){
						$('#gallery-slider-<?php echo $postID; ?>').addClass("loaded");
					}
        ...
        <div class="ut-gallery-wrap">
            <div class="ut-gallery-slider flexslider" id="gallery-slider-<?php echo $postID; ?>">
                <ul class="slides">
                    
                    <?php foreach ( $ut_gallery_images as $ID => $imagedata ) : ?>
                
                        <?php if( isset( $imagedata->guid ) && !empty($imagedata->guid) ) {
                        ...
                        <?php if( !empty($image[0]) ) : ?>
                            ...
                            <li>
								...
								<?php $thumbnail = ut_resize( $image , '855' , '425', true , true, true ); ?>
                                <img alt="<?php echo get_the_title( $postID ); ?>" src="<?php echo $thumbnail; ?>" />
