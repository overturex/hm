			...
			<?php while ( have_posts() ) : the_post(); ?>
                ...
                */
                ...
                <?php if( $ut_parallax_section == 'on') : ?>
                    ...
                    <section id="<?php echo $post_name; ?>" data-width="<?php echo $data_width; ?>" class="page-id-<?php echo $post->ID; ?> entry-content parallax-background parallax-banner parallax-section <?php echo $ut_section_width_class; ?> <?php echo $ut_section_skin; ?> <?php echo $ut_section_class; ?> <?php echo $shadow; ?>">
                	<a class="ut-offset-anchor" <?php echo $post_parent; ?> id="section-<?php echo $post_name; ?>"></a>
						...
						<?php if( $ut_overlay_section == 'on') : ?>
                            ...
                            <div class="parallax-overlay <?php echo $ut_overlay_pattern; ?> <?php echo $ut_overlay_pattern_style; ?>"></div>
                ...
                */
                ...
                <section id="<?php echo $post_name; ?>" data-width="<?php echo $ut_section_width; ?>" class="page-id-<?php echo $post->ID; ?> entry-content normal-background <?php echo $ut_section_width_class; ?> <?php echo $ut_section_skin; ?> <?php echo $ut_section_class; ?> <?php echo $shadow; ?>">
                <a class="ut-offset-anchor" <?php echo $post_parent; ?> id="section-<?php echo $post_name; ?>"></a>
                             ...
                             <?php endif; ?>                                    
                                    ...
                                    <?php if( empty( $pagequery ) ) : ?>
                                        ...
                                        <div class="ut-install-note">
                                            ...
                                            <p>
											<?php _e( 'Information: There are no Pages are assigned to the menu yet! Please read the delivered documentation carefully. We recommend to start with the "Start from Scratch Setup" documentation part.' , 'unitedthemes' ); ?> <br />
                                            </p>
